...
void data_out(FILE *fp2, double t, double u[])
{
	...
	fprintf(fp2,"%e %e %e %e %10.9e %e %e %e %e\n",
		t,u[0],u[16],u[17],u[18],u[19],u[20],var.Itotal,var.dvdt);
...
void out_cicr (FILE *fp9, double time, double p[])
{
	...
	fprintf(fp9,"%e %e %e %e %e %e %e %e\n",time,jrel.ca,jrel.Fn,p[13],p[14],p[15],jrel.vss,jrel.uss);
